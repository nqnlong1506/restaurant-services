...
type OrderServiceClient interface {
	MakeOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *orderServiceClient) MakeOrder(ctx context.Context, in *OrderRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
type OrderServiceServer interface {
	MakeOrder(context.Context, *OrderRequest) (*Response, error)
...
func (UnimplementedOrderServiceServer) MakeOrder(context.Context, *OrderRequest) (*Response, error) {
